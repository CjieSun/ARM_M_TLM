#ifndef INSTRUCTION_TABLES_STANDALONE_H
#define INSTRUCTION_TABLES_STANDALONE_H

#include <cstdint>
#include <string>

// Standalone versions without SystemC dependency
...
struct InstructionTableEntry {
    uint8_t opcode_value;    // Opcode value
...
#endif // INSTRUCTION_TABLES_STANDALONE_H